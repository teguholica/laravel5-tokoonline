                ...
                <div class="col-md-12">
                    <div class="latest-product">
                        ...
                        <div class="product-carousel">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="{{ asset('res/frontend/img/product-2.jpg') }}" alt="">
                                    <div class="product-hover">
                                        <a href="{{ route('frontend.cart.add') }}" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> Add to cart</a>
                                        <a href="{{ route('frontend.detail') }}" class="view-details-link"><i class="fa fa-link"></i> See details</a>
                                    </div>
                                </div>
